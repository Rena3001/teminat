...
@section('content')
<form action="{{ route('admin.products.update', $product->id) }}" method="POST" class="row mb-3"
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="file" class="custom-file-pdf form-control " id="pdf_file" name="pdf_file"
                        value="{{ old('pdf_file', $product->pdf_file) }}"
                ...
                <div class="form-group d-flex">
                    ...
                    <input type="file" name="image"
                        ...
                        value="{{ old('image', $product->image) }}" accept="image/*">
                    @error('image')
                    <span class="error invalid-feedback">{{ $message }}</span>
                    @enderror
                </div>
