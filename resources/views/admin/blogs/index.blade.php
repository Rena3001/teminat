...
<div class="card mb-3">
    <div class="card-header p-4 border-bottom bg-body d-flex align-items-center justify-content-between my-3">
        <a class="btn btn-sm btn-phoenix-success" href="{{ route('admin.blogs.create') }}" role="button" aria-controls="basic-example-code">Yenisini əlavə edin</a>
        ...
        <div class="p-4 code-to-copy">
            <div id="tableExample3" data-list='{"valueNames":["order","id","slug","title","parent"],"page":5,"pagination":true}'>
                ...
                <div class="table-responsive">
                    <form id="bulk-delete-form" method="post" action="{{ route('admin.blogs.bulk-delete') }}">
                        @csrf
                        @method('delete')
                                    ...
                                    <td class="align-middle white-space-nowrap text-end pe-0">
                                        <div class="btn-reveal-trigger position-static">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end py-2">
                                                <a class="dropdown-item" href="{{ route('admin.blogs.show', $model->id) }}">
                                                    <span data-feather="info"></span>
                                                </a>
                                                <a class="dropdown-item" href="{{ route('admin.blogs.edit', $model->id) }}">
                                                    <span data-feather="edit"></span>
                                                </a>
                                                <div class="dropdown-divider"></div>
                                                <form action="{{ route('admin.blogs.destroy', $model->id) }}" method="post" onclick="return confirm('Əminsiniz?','Bəli','Xeyir')">
                                                    @csrf
                                                    @method('delete')
