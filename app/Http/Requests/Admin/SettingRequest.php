...
class SettingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'logo_light' => 'nullable|image|mimes:jpg,png,gif,jpeg,svg,webp|max:2024',
            'logo_dark' => 'nullable|image|mimes:jpg,png,gif,jpeg,svg,webp|max:2024',
            'favicon' => 'nullable|image|mimes:jpg,png,gif,jpeg,svg,webp|max:2024',
    ...
    public function messages(): array
    {
        return [
            ...
            'logo_light.required' => 'Şəkil seçilməlidir',
            'logo_dark.required' => 'Şəkil seçilməlidir',
            'favicon.required' => 'Şəkil seçilməlidir',
            ...
            'logo_light.max' => 'Maksimum ölçüsü :max kb ola bilər',
            'logo_dark.max' => 'Maksimum ölçüsü :max kb ola bilər',
            'favicon.max' => 'Maksimum ölçüsü :max kb ola bilər',
